    ...
    def sheet_update(self, info, date, country_code, db):
        ...
        for site_name, doc_info in info.items():
            ...
            if not wk_sheet:
                ...
                headers = ["DATE", "TOTAL PRODUCTS", "INSTOCK", "MASTER DATA COUNT", "NEW ENTRIES", "OUTOFSTOCK", "MISSING ITEMS"]
